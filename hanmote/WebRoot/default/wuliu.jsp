...
<div class="formtitle1"><span id="placeStr" >物流</span></div>
 <div class="frmBox">
  <table class="tablelist">
        ...
        <tr>
        <td>———物流系统分开</td>
        <td>物流管理系统的应用的材料，生产控制和分配。结果从沃尔沃</td>
        </tr> 
        
        <tr>
        <td>———交付精度</td>
        <td>评估供应商证明满足要求能力正确的数量和按时交付</td>
        
        </tr> 
        
        <tr>
        <td>———物料通过时间</td>
        <td>工作将导致绝对无误的质量交付</td>
        
        </tr> 
       	
       	<tr>
        <td>———电子通讯</td>
        <td>评估供应商能力交付电子数据根据沃尔沃</td>
