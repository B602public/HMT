...
<div class="formtitle1"><span id="placeStr" >技术</span></div>
 <form id="" action="" method="post">
	    ...
	    <div  class="regLine hg250">
	    	...
	    	<a id="addTech" href="#" class="easyui-linkbutton" data-options="iconCls:'icon-add',plain:true" onclick="" ></a>
	    	<a id="removeTech" href="#" class="easyui-linkbutton" data-options="iconCls:'icon-remove',plain:true" onclick=""></a>
